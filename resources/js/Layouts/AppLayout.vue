        ...
        <nav class="bg-white border-b border-gray-100">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link  v-if="$page.user" :href="route('threads.index', {by: $page.user.name})">
                                My Threads
                            </jet-nav-link>
                            <jet-nav-link  :href="route('threads.index', {popularity: 1})">
                                Populars
                            </jet-nav-link>
                        ...
                        <div class="mx-10">
                            <jet-dropdown align="right" width="48">
                                ...
                                <template #content>
                                    <jet-dropdown-link v-for="channel in $page.channels"
                                                       :href="route('threads.index', channel.slug)" :key="channel.id">
                                        {{ channel.name }}
                                    </jet-dropdown-link>
                                </template>
                            </jet-dropdown>
                        ...
                        <div>
                            <inertia-link v-if="$page.user" :href="route('threads.create')"
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div v-if="$page.user" class="flex items-center px-4">
